...
public class Start {
	...
	Start(Control control){
		...
		myFrame.getContentPane().add(curText);
		...
		myFrame.getContentPane().add(btnAddNode);
		...
		myFrame.getContentPane().add(btnAddNode_1);
		...
		myFrame.getContentPane().add(btnAddEdge);
		...
		myFrame.getContentPane().add(btnRemove);
		...
		myFrame.getContentPane().add(btnSetInputNode);
		...
		myFrame.getContentPane().add(btnSetOutputNode);
		...
		myFrame.getContentPane().add(solve);
	        	...
	        	public void mousePressed( MouseEvent e){
	        		...
	        		case addEdgeAction:
	        			if( !firstAdded ){
	        				...
	        				if( ee != null ){
	        					String input = JOptionPane.showInputDialog(myFrame, "Enter Weight for the Edge :");
	        					double w ;
	        					try{
